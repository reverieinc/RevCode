...
def get_indic_normalized(in_str):
    ...
    while i < length:
        ...
        # DEVANAGARI STARTS
        if i < length - 2 and ord(in_str[i]) == 0x905 and \
                ord(in_str[i + 1]) == 0x93E and ord(in_str[i + 2]) == 0x945:
            out_str.append(chr(0x911))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0x905 and \
                ord(in_str[i + 1]) == 0x93E and ord(in_str[i + 2]) == 0x946:
            out_str.append(chr(0x912))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0x905 and \
                ord(in_str[i + 1]) == 0x93E and ord(in_str[i + 2]) == 0x947:
            out_str.append(chr(0x913))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0x905 and \
                ord(in_str[i + 1]) == 0x93E and ord(in_str[i + 2]) == 0x948:
        ...
        # GUJARATI STARTS
        elif i < length - 2 and ord(in_str[i]) == 0xA85 and \
                ord(in_str[i + 1]) == 0xABE and ord(in_str[i + 2]) == 0xAC5:
            out_str.append(chr(0xA91))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0xA85 and \
                ord(in_str[i + 1]) == 0xABE and ord(in_str[i + 2]) == 0xAC7:
            out_str.append(chr(0xA93))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0xA85 and \
                ord(in_str[i + 1]) == 0xABE and ord(in_str[i + 2]) == 0xAC8:
        ...
        # TELUGU STARTS
        elif i < length - 2 and ord(in_str[i]) == 0xc2c and \
                ord(in_str[i + 1]) == 0xc41 and ord(in_str[i + 2]) == 0xc41:
        ...
        # KANNADA STARTS
        elif i < length - 2 and ord(in_str[i]) == 0xcc6 and \
                ord(in_str[i + 1]) == 0xcc2 and ord(in_str[i + 2]) == 0xcd5:
        ...
        elif i < length - 2 and ord(in_str[i]) == 0xd23 and \
                ord(in_str[i + 1]) == 0xd4d and ord(in_str[i + 2]) == 0x200D:
            out_str.append(chr(0xd7A))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0xd28 and \
                ord(in_str[i + 1]) == 0xd4d and ord(in_str[i + 2]) == 0x200D:
            out_str.append(chr(0xd7B))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0xd30 and \
                ord(in_str[i + 1]) == 0xd4d and ord(in_str[i + 2]) == 0x200D:
            out_str.append(chr(0xd7C))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0xd32 and \
                ord(in_str[i + 1]) == 0xd4d and ord(in_str[i + 2]) == 0x200D:
            out_str.append(chr(0xd7D))
            i += 3

        elif i < length - 2 and ord(in_str[i]) == 0xd33 and \
                ord(in_str[i + 1]) == 0xd4d and ord(in_str[i + 2]) == 0x200D:
